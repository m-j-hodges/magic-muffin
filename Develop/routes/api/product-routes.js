...
router.delete('/:id', async (req, res) => {
  const requestDelete = req.params.id
const findItem = await Product.destroy({where: {
  id: requestDelete
}})
if(findItem) {
  res.json({message: `The requested Product with ID ${req.params.id} was deleted.`})
} else {
  res.json({message: 'There was an error processing your request for deletion.'})
}
